...
# Bot information
API_ID = environ.get('API_ID', '27258953')  #api id of your telegram id
if len(API_ID) == 0:
    print('Error - API_ID is missing, exiting now')
    exit()
else:
    API_ID = int(API_ID)
API_HASH = environ.get('API_HASH', '0add43fc460daca0a86077989cfc414f') #api hash of your telegram id
if len(API_HASH) == 0:
    print('Error - API_HASH is missing, exiting now')
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '6336634972:AAHVc5pU3-K2h-Z69BPpviUifcGN4I3cJh0') #bot token from botfather
if len(BOT_TOKEN) == 0:
    print('Error - BOT_TOKEN is missing, exiting now')
    exit()
PORT = int(environ.get('PORT', '7005')) #don't change anything 

# Bot pics
PICS = (environ.get('PICS', 'https://telegra.ph/file/58fef5cb458d5b29b0186.jpg https://telegra.ph/file/f0aa4f433132769f8970c.jpg https://telegra.ph/file/f515fbc2084592eca60a5.jpg https://telegra.ph/file/20dbdcffaa89bd3d09a74.jpg https://telegra.ph/file/6045ba953af4def846238.jpg')).split()

# Bot Admins
ADMINS = environ.get('ADMINS', '949657126') #apni tg id daalo
if len(ADMINS) == 0:
...
# Channels
INDEX_CHANNELS = [int(index_channels) if index_channels.startswith("-") else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1002096410592').split()]
if len(INDEX_CHANNELS) == 0:
    print('Info - INDEX_CHANNELS is empty')
AUTH_CHANNEL = [int(auth_channels) for auth_channels in environ.get('AUTH_CHANNEL', '-1001622914589').split()]
if len(AUTH_CHANNEL) == 0:
    print('Info - AUTH_CHANNEL is empty')
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002002449152') #bot log channel -1005293546253
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://lokimava1122:8dl8cYMSeoWuwvKN@lokimava.os0mf.mongodb.net/?retryWrites=true&w=majority&appName=lokimava") #mongo db url
...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/moviezz2024')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002005906539") #if is_stream = true then add a channel id ex: -10026393639
if len(BIN_CHANNEL) == 0:
    print('Error - BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "http://bots.hostingup.icu:9005/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
